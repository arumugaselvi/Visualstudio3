<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="MyAudit_KA.Masters.WebForm1" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtEsiDateofIndent" runat="server" class="form-control" TextMode="Date"></asp:TextBox>
                    </div>
